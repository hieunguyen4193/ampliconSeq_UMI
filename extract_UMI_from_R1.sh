...
zcat extracted_UMI.fastq.gz | awk 'NR%4==2' | tr "[ATGCatgc]" "[TACGtacg]" | rev > umi_list.txt
...
awk '{print $1"\n"$2$4"\n"$5"\n"$3$6}' | gzip > /media/hieunguyen/HNHD01/raw_data/amplicon_methyl_with_UMI/test_batch/1-TML1S1_S7501-S7701_R2.modified.fastq.gz
